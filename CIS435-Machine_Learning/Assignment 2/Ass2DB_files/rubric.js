...
var rubricModule = {
    ...
    {
      document.forms.rubricManagerForm.action = "/webapps/blackboard/execute/manageRubrics?dispatch=edit&context=course&rubricId="
  ...
  {
    document.forms.rubricManagerForm.action="/webapps/blackboard/execute/manageRubrics?dispatch=listAssociatedContents&context=course&rubricId=" + id + "&course_id=" + window.courseId;
    document.forms.rubricManagerForm.submit();
  },

  copyRubric : function( id )
  {
    document.forms.rubricManagerForm.action="/webapps/blackboard/execute/manageRubrics?dispatch=copy&context=course&rubricId=" + id + "&course_id=" + window.courseId;
    document.forms.rubricManagerForm.submit();
  },
  ...
  viewRubric : function( id )
  {
    ...
    var viewUrl = "/webapps/blackboard/execute/manageRubrics?dispatch=view&context=course&rubricId=" + id + "&course_id=" + window.courseId;
  ...
  previewRubric : function( id, cId, closeLightbox )
  {
    ...
    var windowId = new Date().getTime();
    var viewUrl = "/webapps/blackboard/execute/manageRubrics?dispatch=view&context=course&rubricId=" + id + "&course_id=" + cId;
    var remote = window.open( viewUrl, windowId, 'width=800,height=500,resizable=yes,scrollbars=yes,status=yes,toolbar=no,menubar=no,location=no,directories=no,top=20,left='+ (screen.width - 800) );
    if ( remote )
    {
      remote.focus();
  ...
  {
    var viewUrl = "/webapps/blackboard/execute/manageRubrics?dispatch=view&context=course&rubricId=" + id + "&course_id=" + cId + "&fromLightbox=true";
    _cId = cId;
    _viewUrl = viewUrl;
  ...
  {
    document.forms.rubricManagerForm.action = "/webapps/blackboard/execute/manageRubrics?dispatch=view&context=course&rubricId=" + id + "&course_id=" + cId;
    document.forms.rubricManagerForm.submit();
  },
  ...
  {
    var windowId = new Date().getTime();
    var viewUrl = "/webapps/blackboard/execute/rubricManager?cmd=listRubricAssociations&context=course&course_id=" + courseId +
  ...
  deleteRubric : function( id )
  {
    ...
    document.forms.rubricManagerForm.action="/webapps/blackboard/execute/manageRubrics?dispatch=delete&context=course&rubricId=" + id + "&course_id=" + window.courseId;
    document.forms.rubricManagerForm.submit();
  },
  ...
  validateRemove : function (type )
  {
    ...
    if ( this.validateCheckBoxSelection() )
    {
        ...
        if ( !type || type=='rubric' )
        {
          document.forms.rubricManagerForm.action="/webapps/blackboard/execute/manageRubrics?dispatch=delete&context=course&course_id=" + window.courseId;
        }
        else
        {
          document.rubricManagerForm.selectedRubricIds.value = this.collectCheckBoxSelection();
          document.forms.rubricManagerForm.action="/webapps/blackboard/execute/rubricManager?cmd=deleteAssociations&context=course&course_id=" + window.courseId;
        }
        document.forms.rubricManagerForm.submit();
    }
 },
  ...
  validateExport : function ( )
  {
    ...
    {
      document.rubricManagerForm.selectedRubricIds.value = this.collectCheckBoxSelection();
      document.forms.rubricManagerForm.action="/webapps/blackboard/execute/manageRubrics?dispatch=exportSettings&course_id=" + window.courseId;
      document.forms.rubricManagerForm.submit();
    }
  },
...
{
   var location = "/webapps/blackboard/execute/rubricManager?cmd=listRubricAssociations&context=course&course_id=" +
...
rubricModule.refreshPanel = function( panelId, contentType, contentId, courseId, mode, associations, pointsPossibleElement, onPanelUpdatedIn, pickedRubrics )
{
  ...
  var refreshPanelUrl = "/webapps/blackboard/execute/rubricManager?cmd=refreshList&course_id=" + courseId +
...
rubricModule.panel.prototype =
{
  ...
  {
    var location = "/webapps/blackboard/execute/rubricManager?cmd=rubricPicker&context=course&course_id=" + this.courseId +
  ...
  {
    var location = "/webapps/blackboard/execute/manageRubrics?dispatch=create&popup=true&course_id=" + this.courseId +
                   "&panelId=" + this.panelId +
                   "&entityId=" + this.entityId +
                   "&entityType=" + this.entityType +
                   "&mode=" + this.mode;
  ...
  {
    var location = "/webapps/blackboard/execute/manageRubrics?dispatch=edit&popup=true&course_id=" + this.courseId +
                   "&panelId=" + this.panelId +
                   "&entityId=" + this.entityId +
                   "&entityType=" + this.entityType +
                   "&rubricId=" + rubricId +
